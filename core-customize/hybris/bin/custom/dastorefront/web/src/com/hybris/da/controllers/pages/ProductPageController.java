...
public class ProductPageController extends AbstractPageController
{
			...
			throws CMSItemNotFoundException, UnsupportedEncodingException
	{
		...
		model.addAttribute("siteKey", configurationService.getConfiguration().getProperty("google.recaptcha.key.site"));
			...
			throws CMSItemNotFoundException
	{
		...
		try
		{
			if (!captchaService.processResponse(form.getResponse()))
			{
				result.reject("Detected fraud activity");
			}
		}
