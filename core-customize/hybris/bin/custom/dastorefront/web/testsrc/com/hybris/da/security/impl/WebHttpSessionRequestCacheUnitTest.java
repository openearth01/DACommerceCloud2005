...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/dastorefront/electronics/en",
						"https://electronics.local:9002/dastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/dastorefront/electronics/en",
						"https://electronics.local:9002/dastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/dastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/dastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/dastorefront/electronics/en",
						"https://electronics.local:9002/dastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/dastorefront",
						"https://electronics.local:9002/dastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/dastorefront",
						"https://electronics.local:9002/dastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/dastorefront/electronics/en",
						"https://electronics.local:9002/dastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
