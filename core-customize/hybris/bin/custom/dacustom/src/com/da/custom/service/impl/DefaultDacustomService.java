...
public class DefaultDacustomService implements DacustomService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDacustomService.class);
	...
	{
		return DefaultDacustomService.class.getResourceAsStream("/dacustom/sap-hybris-platform.png");
	}
