...
import com.da.dastore.constants.DastoreConstants;


@SystemSetup(extension = DastoreConstants.EXTENSIONNAME)
public class DastoreSystemSetup extends AbstractSystemSetup
{
	public static final String ELECTRONICS = "electronicsda";
