...
public class DefaultDastoreService implements DastoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDastoreService.class);
	...
	{
		return DefaultDastoreService.class.getResourceAsStream("/dastore/sap-hybris-platform.png");
	}
