...
<c:if test="${component.uid eq 'OrderComponent'}">
	 <spring:message code="header.quickorder" var="quickTitle" />
</c:if>
<c:if test="${component.visible}"> 

        <div class="${navigationClassHtml} js-${navigationClassHtml} display-none NAVcompONENT" data-title="${fn:escapeXml(component.navigationNode.title)}" title="${quickTitle}">                                         
